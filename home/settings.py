...
ADMIN_USER_NAME=config("ADMIN_USER_NAME", default="Ahmed Hodi")
...
STATICFILES_DIRS = [
    BASE_DIR / 'theme' / 'static',  # Tailwind CSS compiled output
]

# WhiteNoise configuration for efficient static file serving
# This allows Django/Gunicorn to serve static files on port 8000
# while Nginx continues to serve them on port 80
